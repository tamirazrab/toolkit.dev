...
export const getBlocksTool = createBaseTool({
  ...
  inputSchema: z.object({
    block_id: z.string().describe("The ID of the block or page to retrieve children from"),
  ...
  outputSchema: z.object({
    results: z.array(
      z.object({
        ...
        archived: z.boolean(),
        content: z.record(z.unknown()).describe("Block-specific content based on type"),
      })
    ),
    has_more: z.boolean(),
